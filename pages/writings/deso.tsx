...
<Head>
		<title>Decentralized Social | Rajan Agarwal</title>
    ...
    color="white">
      <Box w="full" align="left" justify="center" mx="auto" px={{ base: '1%', md: '5%', xl: '17%' }}>
        <Heading 
          ...
          color='#949494'
        >
          <Link href="/">rajan</Link> / <Link href="/writings">writings</Link> / deso
          <br/>
        </Heading>
        <FadeIn>
        <Heading
        ...
        >
          <strong>A Case for Decentralized Social</strong>
        </Heading>
				<Heading
          as="h3"
          fontFamily="Newsreader"
        ...
        <Heading
          ...
          color={useColorModeValue("gray.100", "white")}
        >
Startup Case Study, a DAO for Decentralized Social.
<br/><br/><br/>
...
<br/><br/>
But what is decentralization? In this process, decision making and control is transferred to the users, rather than the owners. Specifically, this avoids central governance by allowing members to securely interact and share; this is the first time a consumer can truly voice their concerns.
<br/><br/>
